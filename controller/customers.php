   ...
   <div id="container">
            ...
            <div class="center">
               <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
                  <table>
                     ...
                     <tr>
                        <td><input type="text" id="company" name="company" placeholder="Nombre De la Compañia"></td>
      ...
      <div class="container_major container_customer">
         ...
         <div class="barra">
            ...
            <div class="botton">
               <button type="button" name="new_client" id="new_client" class="btn_register">Nuevo Cliente</button>
            </div>
         </div>
